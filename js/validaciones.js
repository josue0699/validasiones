export function valida(input) {
  ...
  const mensajesDeError = {
    ...
    password: {
      ...
      patternMismatch:
        "Al menos 8 caracteres, debe contener una letra minúscula, una letra mayúscula, un número y debe contener caracteres especiales.",
    },
    nacimiento: {
    ...
    ciudad:{
      valueMissing: 'Este campo no puede estar vacio.',
      patternMismatch: 'La direccion debe tener entre 4 y 30 caracteres'
    },
    estado:{
      valueMissing: 'Este campo no puede estar vacio.',
      patternMismatch: 'La direccion debe tener entre 4 y 30 caracteres'
  ...
  function validarNacimiento(input) {
    ...
    } else if (!mayorDeEdad(fechaCliente)) {
